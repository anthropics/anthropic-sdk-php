...
final class MessagesService implements MessagesContract
{
     ...
     * @param string|BetaContainerParams|null $container container identifier for reuse across requests
     * @param BetaContextManagementConfig|null $contextManagement Context management configuration.
     *
