...
use Anthropic\Beta\Messages\BetaImageBlockParam\Transformations\OversizedImage;
 ...
 *
 * @phpstan-type TransformationsShape = array{
 *   oversizedImage?: null|OversizedImage|value-of<OversizedImage>
 * }
 */
final class Transformations implements BaseModel
{
    /** @use SdkModel<TransformationsShape> */
    use SdkModel;
