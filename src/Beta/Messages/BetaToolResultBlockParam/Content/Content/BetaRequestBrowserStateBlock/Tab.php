 ...
 *
 * @phpstan-type TabShape = array{
 *   tabID: string, title: string, url: string, active?: bool|null
 * }
 */
final class Tab implements BaseModel
{
    /** @use SdkModel<TabShape> */
    use SdkModel;
    ...
    /**
     * `new Tab()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * Tab::with(tabID: ..., title: ..., url: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Tab)->withTabID(...)->withTitle(...)->withURL(...)
     * ```
     */
