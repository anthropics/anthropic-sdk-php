...
namespace Anthropic\Messages\MessageCreateParams\Container;

use Anthropic\Core\Attributes\Optional;
use Anthropic\Core\Concerns\SdkModel;
use Anthropic\Core\Contracts\BaseModel;
use Anthropic\Messages\MessageCreateParams\Container\ContainerParams\Skill;

/**
 * Container parameters with skills to be loaded.
 *
 * @phpstan-import-type SkillShape from \Anthropic\Messages\MessageCreateParams\Container\ContainerParams\Skill
 *
