...
namespace Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801;

use Anthropic\Core\Attributes\Optional;
use Anthropic\Core\Concerns\SdkModel;
use Anthropic\Core\Contracts\BaseModel;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\CloseTab;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\DoubleClick;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\FileUpload;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Find;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\FormInput;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\GetPageText;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\HoldKey;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Hover;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\JavascriptExec;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Key;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\LeftClick;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\LeftClickDrag;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\LeftMouseDown;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\LeftMouseUp;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\ListTabs;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\MiddleClick;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\MouseMove;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Navigate;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\NewTab;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\ReadConsole;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\ReadNetwork;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\ReadPage;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\RightClick;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Screenshot;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Scroll;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\ScrollTo;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\SwitchTab;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\TripleClick;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Type;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Wait;
use Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Zoom;
 ...
 *
 * @phpstan-import-type CloseTabShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\CloseTab
 * @phpstan-import-type DoubleClickShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\DoubleClick
 * @phpstan-import-type FileUploadShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\FileUpload
 * @phpstan-import-type FindShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Find
 * @phpstan-import-type FormInputShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\FormInput
 * @phpstan-import-type GetPageTextShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\GetPageText
 * @phpstan-import-type HoldKeyShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\HoldKey
 * @phpstan-import-type HoverShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Hover
 * @phpstan-import-type JavascriptExecShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\JavascriptExec
 * @phpstan-import-type KeyShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Key
 * @phpstan-import-type LeftClickShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\LeftClick
 * @phpstan-import-type LeftClickDragShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\LeftClickDrag
 * @phpstan-import-type LeftMouseDownShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\LeftMouseDown
 * @phpstan-import-type LeftMouseUpShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\LeftMouseUp
 * @phpstan-import-type ListTabsShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\ListTabs
 * @phpstan-import-type MiddleClickShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\MiddleClick
 * @phpstan-import-type MouseMoveShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\MouseMove
 * @phpstan-import-type NavigateShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Navigate
 * @phpstan-import-type NewTabShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\NewTab
 * @phpstan-import-type ReadConsoleShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\ReadConsole
 * @phpstan-import-type ReadNetworkShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\ReadNetwork
 * @phpstan-import-type ReadPageShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\ReadPage
 * @phpstan-import-type RightClickShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\RightClick
 * @phpstan-import-type ScreenshotShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Screenshot
 * @phpstan-import-type ScrollShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Scroll
 * @phpstan-import-type ScrollToShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\ScrollTo
 * @phpstan-import-type SwitchTabShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\SwitchTab
 * @phpstan-import-type TripleClickShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\TripleClick
 * @phpstan-import-type TypeShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Type
 * @phpstan-import-type WaitShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Wait
 * @phpstan-import-type ZoomShape from \Anthropic\Messages\MessageCountTokensTool\BrowserToolset20260801\Configs\Zoom
 *
