...
final class MiddlewareThirdPartyTest extends TestCase
{
    ...
    public function testVertexMiddlewareSeesCanonicalRequestTransportSeesVertexRequest(): void
    {
        ...
        $client = VertexClient::withAccessToken(
    ...
    public function testRewriteDropsBetaQueryParamButKeepsOthers(): void
    {
        ...
        $vertex = VertexClient::withAccessToken('t', location: 'us-east5', projectId: 'p', requestOptions: ['transporter' => $vertexT, 'middleware' => [$mw]]);
    ...
    {
        $transporter = $this->transporter();
        $client = VertexClient::withAccessToken('t', location: 'us-east5', projectId: 'p', baseUrl: 'https://gw.example/proxy', requestOptions: ['transporter' => $transporter]);

        $client->messages->create(maxTokens: 1, messages: [], model: 'claude-3-7-sonnet@20250219');

        $this->assertSame(
            '/proxy/v1/projects/p/locations/us-east5/publishers/anthropic/models/claude-3-7-sonnet@20250219:rawPredict',
            $this->lastRequest($transporter)->getUri()->getPath(),
        );
    }
    ...
    {
        $transporter = $this->transporter();
        $client = VertexClient::withAccessToken('default-token', location: 'us-east5', projectId: 'p', requestOptions: ['transporter' => $transporter]);
    ...
    public function testVertexStreamRoutesToStreamRawPredictAndKeepsStreamInBody(): void
    {
        ...
        $client = VertexClient::withAccessToken('t', location: 'us-east5', projectId: 'p', requestOptions: ['transporter' => $transporter, 'streamingTransporter' => $transporter]);
    ...
    public function testVertexBatchesThrowsNotSupported(): void
    {
        ...
        $this->expectExceptionMessageMatches('/\/v1\/messages\/batches.*not supported.*Vertex/i');
    ...
    public function testVertexModelsThrowsNotSupported(): void
    {
        ...
        $this->expectException(AnthropicException::class);
        $this->expectExceptionMessageMatches('/\/v1\/models.*not supported.*Vertex/i');
        $client->models->list();
    }
    ...
    public function testBedrockBatchesThrowsNotSupported(): void
    {
        ...
        $this->expectException(AnthropicException::class);
        $this->expectExceptionMessageMatches('/\/v1\/messages\/batches.*not supported.*Bedrock/i');
        $client->messages->batches->create(requests: []);
    }
    ...
    public function testBedrockModelsThrowsNotSupported(): void
    {
        ...
        $this->expectException(AnthropicException::class);
        $this->expectExceptionMessageMatches('/\/v1\/models.*not supported.*Bedrock/i');
        $client->models->list();
    }
